    ...
    <>
      <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
        <div className="mx-auto mb-10 sm:max-w-lg">
          ...
          <p className="mt-5 text-gray-600 sm:text-lg">Choose your plan!</p>
        </div>
          ...
          <TooltipProvider>
            {pricingItems.map(({ plan, tagline, quota, features }) => {
              ...
              return (
                ...
                >
                  {plan === "Pro" && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 px-3 py-2 text-sm font-medium text-white">
                      Upgrade now
                    </div>
                  )}
